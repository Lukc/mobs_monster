...
mobs:register_mob("mobs_monster:stone_monster", {
	...
	drops = {
		...
		{name = "default:copper_lump", chance = 5, min = 1, max = 3},
...
mobs:register_spawn("mobs_monster:stone_monster", {"default:stone", "default:desert_stone", "default:sandstone"}, 7, 0, 3500, 2, 8)
